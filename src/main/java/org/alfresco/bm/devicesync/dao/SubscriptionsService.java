...
{
    void addSubscription(String siteId, String username, String subscriberId,
    ...
    void updateSubscription(ObjectId objecId, String subscriptionId,
            DataCreationState state);
    ...
    List<SubscriptionData> getSubscriptions(DataCreationState state, int skip,
            int count);
