...
public class CreatePeriodicSubscribersData
{
	...
	public CreatePeriodicSubscribersData(int numSubscribersPerBatch, int timeBetweenBatches, int max,
			int count)
    {
	    super();
	...
	public static CreatePeriodicSubscribersData fromDBObject(DBObject dbObject)
    {
    	...
    	int numSubscribersPerBatch = (Integer)dbObject.get(FIELD_NUM_SUBSCRIBERS_PER_BATCH);
    	int max = (Integer)dbObject.get(FIELD_MAX);
    	int count = (Integer)dbObject.get(FIELD_COUNT);
    	CreatePeriodicSubscribersData prepareSubscribersData = new CreatePeriodicSubscribersData(numSubscribersPerBatch,
