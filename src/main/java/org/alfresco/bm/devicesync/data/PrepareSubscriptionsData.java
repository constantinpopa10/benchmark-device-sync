...
public class PrepareSubscriptionsData
{
	...
	public PrepareSubscriptionsData(Integer maxSubscriptions, Integer numNewSubscriptions)
    {
	    super();
    ...
    {
    	Integer maxSubscriptions = (Integer)dbObject.get(FIELD_MAX_SUBSCRIPTIONS);
    	Integer numNewSubscriptions = (Integer)dbObject.get(FIELD_NUM_NEW_SUBSCRIPTIONS);
    	PrepareSubscriptionsData prepareSubscriptionsData = new PrepareSubscriptionsData(maxSubscriptions,
    			numNewSubscriptions);
