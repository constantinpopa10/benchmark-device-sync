...
public class CreatePeriodicSubscriptionsData
{
    ...
    public CreatePeriodicSubscriptionsData(int numSubscriptionsPerBatch,
    ...
    public static CreatePeriodicSubscriptionsData fromDBObject(DBObject dbObject)
    {
        ...
        int numSubscriptionsPerBatch = (Integer) dbObject
                .get(FIELD_NUM_SUBSCRIPTIONS_PER_BATCH);
        int max = (Integer) dbObject.get(FIELD_MAX);
        int count = (Integer) dbObject.get(FIELD_COUNT);
        CreatePeriodicSubscriptionsData prepareSubscriptionsData = new CreatePeriodicSubscriptionsData(
                numSubscriptionsPerBatch, timeBetweenBatches, max, count);
