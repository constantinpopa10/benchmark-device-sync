...
public class SyncStateData
{
    ...
    public SyncStateData(Alfresco alfresco, ObjectId objectId, String username,
    ...
    {
        SyncStateData syncStateData = new SyncStateData(alfresco, objectId,
                username, subscriberId, subscriptionId);
    ...
    public SyncStateData startSync(SyncsService syncsService)
    {
        ...
        try
        {
            ...
            StartSyncResponse response = alfresco.startSync(req, "-default-",
    ...
    public SyncStateData getSync(SyncsService syncsService)
    {
        ...
        try
        {
            if (syncId != null)
            {
                GetSyncChangesResponse response = alfresco.getSync("-default-",
                        getSubscriberId(), getSubscriptionId(), syncId);
