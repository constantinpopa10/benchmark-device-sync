...
public class SubscriptionBatchData implements Serializable
{
    ...
    public SubscriptionBatchData(int count, Integer batchSize,
    ...
    public DBObject toDBObject()
    {
        BasicDBObjectBuilder builder = BasicDBObjectBuilder
                ...
                .add(FIELD_NEXT_EVENT_NAME, nextEventName).add("sites", sites);
    ...
    public static SubscriptionBatchData fromDBObject(DBObject dbObject)
    {
        ...
        SubscriptionBatchData subscriptionBatchData = new SubscriptionBatchData(
                count, batchSize, numBatches, waitTimeBetweenBatches,
                nextEventName, sites);
