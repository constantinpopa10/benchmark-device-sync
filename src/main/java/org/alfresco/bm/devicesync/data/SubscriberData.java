...
public class SubscriberData
{
    ...
    public SubscriberData(String username, String subscriberId,
    ...
    public SubscriberData(ObjectId objectId, String username,
            String subscriberId, String syncServiceURI,
    ...
    {
        SubscriberData subscriberData = new SubscriberData(objectId, username,
    ...
    public DBObject toDBObject()
    {
        BasicDBObjectBuilder builder = BasicDBObjectBuilder.start(
                FIELD_USERNAME, getUsername()).add(FIELD_RANDOMIZER,
                getRandomizer());
    ...
    public static SubscriberData fromDBObject(DBObject dbObject)
    {
        ...
        if (dbObject != null)
        {
            ...
            String syncServiceURI = (String) dbObject
                    .get(FIELD_SYNC_SERVICE_URI);
            DataCreationState state = (stateStr != null ? DataCreationState
                    .valueOf(stateStr) : null);
            subscriberData = new SubscriberData(id, username, subscriberId,
                    syncServiceURI, state, randomizer);
        }
        return subscriberData;
    }
