...
public class SubscriberData
{
	...
	public SubscriberData(String username, String subscriberId, DataCreationState state)
    {
		this.username = username;
	...
	public SubscriberData(ObjectId objectId, String username, String subscriberId, DataCreationState state,
			int randomizer)
    {
    ...
    public static SubscriberData fromDBObject(DBObject dbObject)
    {
    	...
    	SubscriberData subscriberData = new SubscriberData(id, username, subscriberId, state, randomizer);
    	return subscriberData;
    }
}
