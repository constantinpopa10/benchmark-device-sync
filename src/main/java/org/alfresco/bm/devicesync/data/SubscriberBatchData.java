...
public class SubscriberBatchData implements Serializable
{
    ...
    public SubscriberBatchData(int count, Integer batchSize,
            Integer numBatches, Integer waitTimeBetweenBatches,
    ...
    public static SubscriberBatchData fromDBObject(DBObject dbObject)
    {
        ...
        Integer waitTimeBetweenBatches = (Integer) dbObject
                .get(FIELD_WAIT_TIME_BETWEEN_BATCHES);
        String nextEventName = (String) dbObject.get(FIELD_NEXT_EVENT_NAME);
        SubscriberBatchData syncData = new SubscriberBatchData(count,
                batchSize, numBatches, waitTimeBetweenBatches, nextEventName);
        return syncData;
    }
}
