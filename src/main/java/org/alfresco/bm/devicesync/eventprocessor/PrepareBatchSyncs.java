...
public class PrepareBatchSyncs extends AbstractEventProcessor
{
     ...
     */
    public PrepareBatchSyncs(SubscriptionsService subscriptionsService,
            SyncsService syncsService, int maxSyncs,
            ...
            else
            {
                for (int i = 0; i < maxSyncs; i++)
                {
                    ...
                    syncsService.addSync(subscriptionData.getUsername(),
                            ...
                            SyncState.NotScheduled);
                }

                // subscriptionsService.getSubscriptions(DataCreationState.Created,
                // 0, maxSyncs);
                ...
                msg = "Prepared " + maxSyncs + " syncs and raising '"
                        + event.getId() + "' event.";
            }
