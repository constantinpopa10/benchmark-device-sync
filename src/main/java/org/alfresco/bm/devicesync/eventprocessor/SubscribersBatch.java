...
public class SubscribersBatch extends AbstractEventProcessor
{
    ...
    protected EventResult processEvent(Event event) throws Exception
    {
        ...
        SubscriberBatchData subscriberBatchData = SubscriberBatchData
        ...
        Integer waitTimeBetweenBatchesParameter = subscriberBatchData
        ...
        try
        {
            ...
            else
            {
                ...
                // we create subscribers based on users who are members of
                // sites...
                try (Stream<SiteMemberData> siteMembers = siteDataService
                        .randomSiteMembers(DataCreationState.Created,
                                new String[]
                    ...
                    List<Event> events = siteMembers
                            .map(sm -> {
                                ...
                                Event nextEvent = new Event(
                                        eventNameCreateSubscriber,
                                        scheduledTime, subscriberData
                                                .toDBObject());
                                return nextEvent;
                ...
                {
                    final long nextBatchScheduledTime = System
                            .currentTimeMillis() + waitTimeBetweenBatches;
                    SubscriberBatchData newSubscriberBatchData = new SubscriberBatchData(
