...
public class SyncBatch extends AbstractEventProcessor
{
     ...
     */
    public SyncBatch(SubscriptionsService subscriptionsService, int batchSize, int numBatches,
    		int waitTimeBetweenBatches, String eventNameStartSync)
    {
            ...
            {
            	{
	            	for(int i = 0; i < batchSize; i++)
	            	{
	            		...
	            		SyncData syncData = new SyncData(subscriptionData.getUsername(), subscriptionData.getSubscriberId(),
...

            	{
	            	...
	            	SyncBatchData newSyncBatchData = new SyncBatchData(count + 1);
